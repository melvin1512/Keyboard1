...
public class keylib1 {
    ...
    public keylib1(Activity act, final EditText editText, KeyboardView keyboardView) {
        ...
        editText.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View view, boolean b) {
                if (!b) {
                    ...
                    mImm.hideSoftInputFromWindow(view.getWindowToken(), 0); //hide keyboard
                }
            }
        });
